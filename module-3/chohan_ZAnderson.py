...
while True:  # Main game loop.
    # Place your bet:
    print('You have', purse, 'mon. If you roll a 2 or 7  on a dice roll there is a 10 mon bonus. How much do you bet? (or QUIT)')
    while True:
        pot = input('ZPA: ')
        if pot.upper() == 'QUIT':
    ...
    # Check for 2 or 7 bonus:
    rollTotal = dice1 + dice2

    if rollTotal == 2 or rollTotal == 7:
        print(f'Bonus! The total was {rollTotal}. You receive a 10 mon bonus.')
    purse += 10
